...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const id = parseInt(pokemonID, 10); //it takes the pokemon ID string and turns it into a number (10 - decimal system)
...
async function loadPokemon(id) {
  try {
    //fetch Pokemon id and specie data
    ...
    if (currentPokemonId === id) {
      ...
      //changing URL without reloding the page
...
//all background colors based on Pokemon type
const typeColors = {
  normal: "#A8A878",
  fire: "#F08030",
  water: "#6890F0",
...
function setTypeBackgroundColor(pokemon) {
  ...
  //color for progress bar and value
